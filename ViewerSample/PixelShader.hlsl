...
cbuffer Crosshair : register(b0)
{
	...
	float2 cross1;         // ½ÊÀÚ¼± À§Ä¡ (0~1)
	float2 cross2;         // ½ÊÀÚ¼± À§Ä¡ (0~1)
	float2 cross3;         // ½ÊÀÚ¼± À§Ä¡ (0~1)
...
PSOutput PSMain(VSOutput input)
{
 ...
 //   o.color3 = float4(gray3, gray3, gray3, 1.0);*/
  ...
  //  float2 crossUV = ... // viewIndex¿¡ µû¶ó ¼±ÅÃ
  //  bool isCross = abs(uv.x - crossUV.x) < crossThickness || abs(uv.y - crossUV.y) < crossThickness;
    ...
    case 0: 
		...
		o.color0  = float4(viewIndex / 3.0f, 0, 0, 1); // viewIndex¿¡ µû¶ó »¡°­ ³óµµ º¯È­
